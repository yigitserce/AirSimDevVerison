    ...
    IF(UNIX)
        ...
        if (APPLE)
            ...
            if (${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
                ...
                set(CXX_EXP_LIB "-L${LLVM_LIBRARY_DIRS} -ferror-limit=10") # set(CXX_EXP_LIB "-L${LLVM_LIBRARY_DIRS} -lc++fs -ferror-limit=10")
            else()
                set(CXX_EXP_LIB "-fmax-errors=10 -Wnoexcept -Wstrict-null-sentinel") # set(CXX_EXP_LIB "-lstdc++fs -fmax-errors=10 -Wnoexcept -Wstrict-null-sentinel")
            endif ()
        endif ()
